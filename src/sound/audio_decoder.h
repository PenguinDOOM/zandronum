...
struct AudioDecoderTestMiniaudioFlacCallbackReport
{
	...
	std::size_t MetadataCuesheetCount;
	bool MetadataCuesheetRawDataLive;
	std::size_t MetadataCuesheetRawDataSize;
	unsigned int MetadataCuesheetTrackCount;
	bool MetadataCuesheetTrackDataAligned;
	bool MetadataCuesheetIndexDataAligned;
	bool MetadataCuesheetIteratorNullOutputAdvanced;
	bool MetadataCuesheetIteratorEOF;
	unsigned long long MetadataCuesheetLeadInSampleCount;
	unsigned long long MetadataCuesheetFirstTrackOffset;
	unsigned long long MetadataCuesheetFirstIndexOffset;
	unsigned int MetadataCuesheetFirstTrackNumber;
	unsigned int MetadataCuesheetFirstIndexNumber;
	unsigned int MetadataCuesheetSecondTrackNumber;
	bool MetadataCuesheetFirstTrackIsAudio;
	bool MetadataCuesheetFirstTrackPreEmphasis;
	char MetadataCuesheetFirstTrackISRC[13];
	bool MetadataCuesheetRawDataMatchesExpected;
	bool MetadataCuesheetIsCD;
	char MetadataCuesheetCatalog[129];
	unsigned int MetadataCuesheetFirstTrackIndexCount;
	bool MetadataCuesheetFirstTrackIndexPointerNull;
	unsigned long long MetadataCuesheetSecondTrackOffset;
	bool MetadataCuesheetSecondTrackIsAudio;
	bool MetadataCuesheetSecondTrackPreEmphasis;
	char MetadataCuesheetSecondTrackISRC[13];
	unsigned int MetadataCuesheetSecondTrackIndexCount;
	bool MetadataCuesheetSecondTrackIndexPointerNull;
...
struct AudioDecoderTestMiniaudioCuesheetCallbackReport
{
	bool Opened;
	...
	std::size_t MallocCount;
	std::size_t FreeCount;
	bool MetadataRawDataLive;
	unsigned int MetadataTrackCount;
	bool MetadataTrackDataAligned;
	bool MetadataIndexDataAligned;
	bool MetadataIteratorNullOutputAdvanced;
	bool MetadataIteratorEOF;
	bool MetadataRawDataMatchesExpected;
	std::size_t MetadataRawDataSize;
	bool MetadataIsCD;
	char MetadataCatalog[129];
	unsigned long long MetadataLeadInSampleCount;
	unsigned long long MetadataFirstTrackOffset;
	unsigned long long MetadataFirstIndexOffset;
	unsigned int MetadataFirstTrackNumber;
	unsigned int MetadataFirstIndexNumber;
	unsigned int MetadataFirstTrackIndexCount;
	bool MetadataFirstTrackIndexPointerNull;
	bool MetadataFirstTrackIsAudio;
	bool MetadataFirstTrackPreEmphasis;
	char MetadataFirstTrackISRC[13];
	unsigned long long MetadataSecondTrackOffset;
	unsigned int MetadataSecondTrackNumber;
	unsigned int MetadataSecondTrackIndexCount;
	bool MetadataSecondTrackIndexPointerNull;
	bool MetadataSecondTrackIsAudio;
	bool MetadataSecondTrackPreEmphasis;
	char MetadataSecondTrackISRC[13];
	void *AllocationPointers[5];
	void *FreePointers[5];
};
bool AudioDecoderTestMiniaudioFlacCallbackOpen (const unsigned char *data, std::size_t bytes, bool withMetadata, bool reallocOnly, std::size_t failAllocationOrdinal, std::size_t failReadPosition, std::size_t failSeekOrdinal, std::size_t failSeekPosition, AudioDecoderTestMiniaudioFlacCallbackReport *report, bool corruptCanaryBeforeClose = false, const unsigned char *expectedCuesheetRawData = NULL, std::size_t expectedCuesheetRawDataSize = 0);
bool AudioDecoderTestMiniaudioOggFlacCuesheetCallbackOpen (const unsigned char *data, std::size_t bytes, std::size_t failAllocationOrdinal, AudioDecoderTestMiniaudioCuesheetCallbackReport *report, const unsigned char *expectedCuesheetRawData = NULL, std::size_t expectedCuesheetRawDataSize = 0);
